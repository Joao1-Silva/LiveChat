  ...
  return (
    <div className="h-screen bg-zinc-800 text-white flex items-center justify-center">
      ...
      <form onSubmit={handleSubmit} className="bg-zinc-900 p-10">
        <h1 className="text-2x1 font-bold my-2">shoaosChat</h1>
        ...
        <input type="text" onChange={e => setMessage(e.target.value)} value={message} className="border-2 border-zinc-500 p-2 text-black"/>
          <button>send</button>
      </form>
